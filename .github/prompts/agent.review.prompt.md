---
mode: "agent"
description: "Review recent changes against project standards"
---
...
- Compliance: any EUDR-related changes verified against `docs/COMPLIANCE_MATRIX.md`?
- Docstrings on public functions?

## Report

Output: **PASS** or list issues with `file:line` references. Fix any auto-fixable issues immediately.
